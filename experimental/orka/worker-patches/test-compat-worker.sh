...
grep -Fq 'patch_sha256=a41744b308091c23b6c5b00fbc7242c18cee4d0b00a9f8cc83d99c4af82860f6' <<< "$metadata"
backtick='`'
grep -Fq "${backtick}1b6f6f74c8cdf5e3ccfe92d0a7ed03a571670254${backtick}" "$script_dir/COMPATIBILITY.md"
grep -Fq "${backtick}a41744b308091c23b6c5b00fbc7242c18cee4d0b00a9f8cc83d99c4af82860f6${backtick}" "$script_dir/COMPATIBILITY.md"
for patch_file in \
  analysis_budget.go \
  analysis_context.go \
  tool_alias.go \
...
patch=a41744b308091c23b6c5b00fbc7242c18cee4d0b00a9f8cc83d99c4af82860f6
