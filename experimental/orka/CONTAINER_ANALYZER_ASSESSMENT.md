...
Keep the in-process analyzer canonical. The patched `type: ai` analysis mode and worker build assets have been removed
without compatibility scaffolding. Retain
